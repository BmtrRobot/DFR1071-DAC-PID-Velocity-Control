...
encoder_instance enc_instance_M1;
...
float PPR = 1000.0;       // Pulses per revolution
float gear_ratio = 1.0; // Gear ratio
float motor1_vel;       // Motor velocity
float RPM_k;            // RPM constant


float set = 1500; // Set velocity
